...
{proparse/api/proparse.i hproparse}
RUN proparse/api/proparse.p PERSISTENT SET hproparse.
...
parserErrorClear().
parserParse("proparse/unit-test.p").
...
parserErrorClear().
parserParse("proparse/testdata/test3.cls").
RUN checkErrors.
RUN getNewHandles.
parserNodeTop(nh1).
